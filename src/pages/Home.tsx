...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="section-container bg-gradient-to-b from-white to-emerald-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="eco-card staggered-item" ref={el => staggeredRefs.current[0] = el}>
            <div className="w-full h-64 bg-white rounded-lg shadow-lg flex items-center justify-center mb-6 mx-auto overflow-hidden transition-transform duration-300 cursor-pointer">
              <img 
      ...
      <section className="section-container bg-gradient-to-b from-emerald-50 to-white">
        <div className="text-center">
          <h2 className="text-4xl font-bold mb-4 text-primary">Call to Action</h2>
