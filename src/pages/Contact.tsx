  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold mb-8 text-african-dark">Our Location</h2>
          <div className="bg-gray-300 w-full h-72 rounded-lg flex items-center justify-center">
            <p className="text-gray-600">Map placeholder - In a real application, an embedded map would be here</p>
          </div>
        </div>
      </section>
    </div>
