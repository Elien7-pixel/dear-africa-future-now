...
import { Users, Heart, Globe, Target, Award, Calendar, User, Equal, TreePine, Thermometer } from 'lucide-react';
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8 mb-8">
            ...
            <div className="flex-shrink-0 text-center md:text-left">
              <div className="w-48 h-48 mx-auto md:mx-0 mb-4">
                <img 
                  src="/lovable-uploads/f8572505-7a53-4318-9ce8-52455f542dbc.png" 
                  alt="Munya Touch"
      ...
      <section className="bg-african-green/10 section-container">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-6 text-african-green">Alignment with UN SDGs</h2>
          <div className="w-20 h-1 bg-african-orange mx-auto mb-8"></div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg border">
            <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <Equal className="h-8 w-8 text-purple-600" />
            </div>
            <h3 className="text-xl font-bold mb-4 text-african-green text-center">Goal 5: Gender Equality</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border">
            ...
            <h3 className="text-xl font-bold mb-4 text-african-green text-center">Goal 10: Reduced Inequalities</h3>
            <p className="text-gray-600 text-center">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border">
            ...
            <h3 className="text-xl font-bold mb-4 text-african-green text-center">Goal 13: Climate Action</h3>
            <p className="text-gray-600 text-center">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border">
            ...
            <h3 className="text-xl font-bold mb-4 text-african-green text-center">Goal 15: Life on Land</h3>
            <p className="text-gray-600 text-center">
